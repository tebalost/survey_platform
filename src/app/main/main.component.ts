...
export class MainComponent implements OnInit, OnDestroy{
	...
	constructor(public tourService: TourService,
		...
		this.tourService.initialize([{
			anchorId: 'start.tour',
			content: 'Welcome to mHealth admin panel!',
			placement: 'below',
			title: 'Welcome to mHealth',
		},
		{
			anchorId: 'tour-search',
			content: 'Enjoying Search box with suggestion and many more things',
			placement: 'below',
			title: 'Search Box',
		},
		{
	...
	isUserSuperSuper(){
		return  localStorage.getItem('USER_ROLE') === 'SBS';
	}
}
